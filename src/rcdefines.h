...
namespace RC
{
	...
	enum GameKey
	{
		...
		GK_MOVEFRONTMID, GK_MOVEFRONTMIDINV,
		GK_MOVEUPMID, GK_MOVEUPMIDINV,
		GK_MOVERIGHTMID, GK_MOVERIGHTMIDINV,
		...
		GK_MOVELAST = GK_MOVERIGHTMIDINV
	};
	...
	enum MoveType
	{
		...
		MT_FRONTMID 	= GK_MOVEFRONTMID,
		MT_FRONTMIDINV 	= GK_MOVEFRONTMIDINV,
		MT_UPMID 		= GK_MOVEUPMID,
		MT_UPMIDINV 	= GK_MOVEUPMIDINV,
		MT_RIGHTMID 	= GK_MOVERIGHTMID,
		MT_RIGHTMIDINV 	= GK_MOVERIGHTMIDINV,

		MT_NONE = GK_NONE,
		MT_COUNT = GK_MOVELAST - GK_MOVEFIRST + 1,
		MT_FIRST = MT_FRONT,
		MT_LAST = MT_RIGHTMIDINV
	};
}
